...
AGENTS: list[Agent] = [
    Agent(
        ...
        label="Brief",
        kind="text",
        tagline="One call. A typed answer, not prose.",
        module=brief,
    ...
    Agent(
        ...
        label="Repo",
        kind="text",
        tagline="Answers from its own source, files cited.",
        module=repo,
    ...
    Agent(
        ...
        label="Research",
        kind="text",
        tagline="A tool loop inside a reflection loop.",
    ...
    Agent(
        ...
        label="Pipeline",
        kind="text",
        tagline="Five roles in parallel, a critic can bounce work.",
        module=pipeline,
    ...
    Agent(
        ...
        label="Analyst",
        kind="text",
        tagline="Router, three parallel specialists, human gate.",
        module=analyst,
        placeholder="SPY",
        interactive=True,
        level=6,
